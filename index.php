...
<body class="bg-dark text-light">
  <header>
    <nav class="navbar navbar-expand-lg bg-black fixed-top">
      <div class="container-fluid">
        ...
        <img src="img/focus-horizontal.svg" alt="un triangle aux trois côtés égaux" style="width: 200px; height: 100px;" />
        <div class="collapse navbar-collapse" id="navbarText">
          ...
          <button type="button" class="btn btn-dark btn-contact" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Contact</button>
          <a class="btn btn-warning" href="index.php#boutique" class="navbar-text" role="button">Achetez le Jeu</a>
        </div>
      </div>
    </nav>
  </header>
  ...
  <main id="synopsis" class="container text-light">
    <h1>A Plague Tale : Innocence est un jeu d'action aventure développé par Asobo Studio et édité par Focus Home Interactive. L'histoire se déroule en France au temps du Moyen-âge <i class="fa-solid fa-chess-king"></i></h1>
    <br/>
    <p class="lead">Vivez le récit déchirant aux multiples récompenses d’Amicia et de son petit frère Hugo, livrés à eux-mêmes au cœur des heures les plus sombres de l’Histoire. Pourchassés par l'Inquisition et cernés par l'avancée inexorable des hordes de rats, Amicia et Hugo vont apprendre à se connaître et à compter l'un sur l'autre. Submergés par l’adversité, ils devront lutter pour survivre et trouver leur rôle dans ce monde impitoyable.</p>
    <br/>
    <p class="lead">1348. Le fléau de la peste ravage le Royaume de France. A travers les villages dévastés par la maladie. Sur leur route, ils devront joindre leurs forces à celles d’autres orphelins, par le feu et la lumière. Grâce au lien qui les unit, les enfants affronteront les jours les plus sombres de l’Histoire pour échapper au destin funeste de leur famille. L’aventure commence sur consoles et PC – Le temps de l’innocence prend fin… Dans l'ancienne province de Guyenne, Le pays est ravagé par la Guerre de Cent Ans (1337-1453), conflit opposant le royaume d'Angleterre et celui de France, ainsi que par le début de la Peste noire et la fin de l'Inquisition médiévale.</p>
    <br/>
    <hr>

    <h2 id="personnages" class="text-center">Les Personnages <i class="fa-thin fa-family"></i></h2>
    <div class="row personnage d-flex justify-content-center">
    ...
    <p class="lead text-center" style="padding-top: 30px;">Vous incarnez Amicia de Rune, une adolescente âgée de 15 ans, accompagnée de son frère cadet, Hugo, âgé de 5 ans, tous deux livrés à eux-mêmes. Bien qu'étant du même sang, les deux enfants se connaissent peu puisque Amicia a été élevée par son père, Robert de Rune, chevalier au service du roi de France, qui lui a appris à chasser, tandis qu'Hugo, atteint d'une mystérieuse maladie du sang, est gardé par sa mère Béatrice de Rune dans sa chambre. Ils vont devoir survivre et ne compter que sur eux-mêmes alors qu'ils sont poursuivis par le seigneur Nicholas, haut membre de l'Inquisition qui tente de capturer Hugo pour le livrer au Grand Inquisiteur, Vitalis Bénévent.</p>
    </div>
  </main>
  ...
  <section class="container">
    ...
    <div class="row">
      <iframe width="800" height="560" src="https://www.youtube-nocookie.com/embed/8AOwiMciL1Q" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
      </iframe>
    </div>
  </section>
  <hr>
  ...
  <section id="gameplay">
    ...
    <section id="fronde">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="row">
              <video src="video/aplague_fronde.mp4" autoplay muted loop style="width: 600px;">
              </video>
            </div>
          </div>
          <div class="col-md-6" style="padding-top: 50px;">
            <h5 class="text-center">La Fronde</h5>
            <p class="lead text-center">Votre fronde constitue une arme redoutable car un tir bien précis dans la tête avec une pierre comme projectile peut-être fatal pour vos ennemie...</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="rat">
      <div class="container">
        <div class="row">
          <div class="col-md-6" style="padding-top: 50px;">
            <h5 class="text-center">Les Rats</h5> <i class="fa-regular fa-mouse-field"></i>
            <p class="lead text-center">La peste fait rage au royaume de France, les rats sont de petits rongeurs à fourrure sombre dans A Plague Tale: Innocence et sont une menace omniprésente à laquelle tous doivent faire face. Apparaissant en grand nombre, ils sont imparables, dévorant ou contaminant tout sur leur passage. Ils peuvent cependant être dissuadés par la lumière.</p>
          </div>
          <div class="col-md-6">
            <div class="row">
              <video src="video/aplague_rat.mp4" autoplay muted loop style="width: 600px;">
              </video>
            </div>
          </div>
        </div>
    ...
    <section id="discretion">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="row">
              <video src="video/aplague_discretion.mp4" autoplay muted loop style="width: 600px;">
              </video>
            </div>
          </div>
          <div class="col-md-6">
            <h5 class="text-center" style="padding-top: 50px;">Discrétion</h5>
            <p class="lead text-center">Analysez votre environnement et utilisez-le à votre avantage, une armée se dresse devant vous. Protéger votre petit frère par la force ou par la furtivité</p>
          </div>
        </div>
      </div>
    </section>

    <!-- Fin section Discrétion -->
    <hr>
    <section id="alchimie">
      <div class="container">
        <div class="row">
          <div class="col-md-6" style="padding-top: 40px;">
            <h5 class="text-center">Alchimie</h5>
            <p class="lead text-center">Au fur et à mesure que le joueur apprend plus de recettes d’alchimie, la roue de munitions d’Amicia s’agrandira pour refléter ses nouvelles capacités. Les joueurs auront accès à quatre types de projectiles alchimiques et deux mélanges qui peuvent être utilisés pour donner un avantage au combat et résoudre des énigmes. Chaque type de munition présente des avantages différents, mais ils ont également leur propre coût en ressources dont les joueurs doivent tenir compte lors de la planification de leurs prochaines étapes.</p>
          </div>
          <div class="col-md-6">
            <div class="row">
              <video src="video/aplague_alchimie.mp4" autoplay muted loop style="width: 600px;">
              </video>
            </div>
          </div>
        </div>
  ...
  <section id="boutique" class="container">
    ...
    <br>
    <div class="row">
      <iframe src="https://store.steampowered.com/widget/752590/" frameborder="0" width="646" height="190">
      </iframe>
    </div>
    <h5>Et sur Console</h5>
    <br>

    <!-- Boutique avec Logo SVG -->
            ...
            <div class="container-fluid">
              ...
              <div class="row justify-content-center">
                <div class="col-lg-8 col-xl-7">
                  <form method="POST" class="needs-validation" novalidate id="contactForm" action="">
                    <!-- Name input-->
                    <div class="form mb-5">
                    ...
                    <div class="form mb-3">
                      ...
                      <textarea class="form-control" id="message" name="message" style="height: 10rem" required>
                      </textarea>
                      <div class="invalid-feedback">
                        <p>Veuillez écrire un message</p>
                      </div>
                    </div>
                    <button class="btn btn-info" id="submit" type="submit">Envoyez</button>
                  </form>
                  <div class="row">
  ...
  <footer class="container-fluid bg-black">
    <p>
      <strong>&copy; Sleyter MONTEIRO & Myriam FARIDI</strong>- Etudiants en Cybersécurité - Guardia Cybersecurity School</p>
    <div class="row">
      <div class="col">
        <a href="https://instagram.com/aplaguetale?igshid=YmMyMTA2M2Y=" target="_blank" class="reseau" rel="nofollow">
          <i class="fa-brands fa-instagram"> Instagram </i>
        </a>
        <a href="https://twitter.com/APlagueTale?s=20&t=dM-jhGQhY3ym9xPh0FYq3g" target="_blank" class="reseau" rel="nofollow">
          <i class="fa-brands fa-twitter" style="padding: 20px;"> Twitter </i>
        </a>
        <a href="https://fr-fr.facebook.com/APlagueTale/" target="_blank" class="reseau" rel="nofollow">
          <i class="fa-brands fa-facebook"> Facebook </i>
        </a>
      </div>
    </div>
    <p>
      <i class="fa-solid fa-triangle-exclamation"></i>Ce site est une fan conception réalisé par des étudiants dans le cadre de leur pédagogie et il n'est donc pas officiel.
      <i class="fa-solid fa-triangle-exclamation"></i>
      <br>Je vous invite à vous rendre sur la page officiel du Jeu
      <a href="https://www.focus-entmt.com/fr/games/a-plague-tale-innocence" target="_blank" style="text-decoration: none;" rel="nofollow">Focus Entertainement</a>
    </p>
  </footer>
