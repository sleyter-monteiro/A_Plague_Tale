...
if (!empty($_POST)) {
	...
	$erreur .='<div class="fw-bolder text-center" style="background-color: #dc3545; border-radius: 8px; margin: 10px; padding: 10px;">Erreur lors de l\'envoi du message</div>';
}
...
<html lang="fr">
	...
	<body class="bg-dark text-light">
		...
		<button class="navbar-toggler bg-dark" type="button" data-bs-toggle="collapse" data-bs-target="#navbarText" aria-controls="navbarText" aria-expanded="false" aria-label="Toggle navigation">
          ...
          <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
			  ...
			  <!-- <li class="nav-item">
                <a class="nav-link text-white" href="index.php#gameplay">Personnages</a>
              </li> -->
			  <li class="nav-item">
                <a class="nav-link text-white" href="index.php#boutique">Achetez le Jeu</a>
              </li>
              <li class="nav-item">
		...
		<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
			...
			<div class="carousel-inner">
				...
				<div class="carousel-item">
					<img src="img/aplague7.jpg" class="d-block w-100" alt="..." />
				</div>
				<div class="carousel-item">
		...
		<main class="container text-light">
			...
			<h2 class="text-center">Les Personnages</h2>
  ...
  <section id="boutique" class="container-fluid">
	...
	<!-- <div class="console d-flex justify-centent-evenly"> -->
		...
		<a class="xbox btn btn-success" href="https://www.xbox.com/fr-fr/games/store/a-plague-tale-innocence/bq2nnlqps8rs" target="_blank" role="button" style="margin: 50px;">
  ...
  <section class="page-section" id="contact">
	<div class="container">
		...
		<div class="row justify-content-center">
				...
				<div class="row"><?php echo $confirmation?></div>
			</div>
		</div>
	</div>
  </section>
